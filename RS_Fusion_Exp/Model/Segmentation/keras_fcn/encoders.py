...
class VGG16(VGGEncoder):
    ...
    def __init__(self, inputs, weight_decay=0.,
        ...
        if weights == 'imagenet':
            weights = '/disk4/wangwentao/Pycharm/Share_D/Segmentation/data/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5'
        else:
            weights = None
...
class VGG19(VGGEncoder):
    ...
    def __init__(self, inputs, weight_decay=0.,
            weights='imagenet', trainable=True):
        if weights == 'imagenet':
            weights = '/disk4/wangwentao/Pycharm/Share_D/Segmentation/data/vgg19_weights_tf_dim_ordering_tf_kernels_notop.h5'
        else:
            weights = None
